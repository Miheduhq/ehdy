      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-7">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4">
            ...
            <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-12 lg:h-12 bg-white rounded-full flex items-center justify-center flex-shrink-0">
              <img 
            ...
            {/* Mobile menu button */}
            <button 
              className="lg:hidden text-white p-1 hover:bg-white/10 rounded-md transition-colors duration-300"
